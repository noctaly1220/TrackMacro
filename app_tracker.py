...
# Settings via session_state pour persistance inter-rerun
...
with tab5:
    ...
    if settings_sub == "🧮 Calculateur":
        ...
        if st.button("💾 Sauvegarder", key="btn_save_settings"):
            new_settings = {"objectif_kcal":new_kcal,"objectif_prot":new_prot,"objectif_gluc":new_gluc,"objectif_lip":new_lip}
            st.session_state["settings"] = new_settings
            save_json(SETTINGS_FILE, new_settings)
