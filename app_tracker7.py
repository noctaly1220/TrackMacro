...
# Settings via session_state — seule source de vérité
_default_settings = {"objectif_kcal":2000,"objectif_prot":150,"objectif_gluc":250,"objectif_lip":65}
if "settings" not in st.session_state:
    st.session_state["settings"] = load_json(SETTINGS_FILE, _default_settings)
# Alias local relu à chaque rerun depuis session_state
    ...
    if settings_sub == "🧮 Calculateur":
        ...
        if st.button("💾 Sauvegarder", key="btn_save_settings"):
            st.session_state["settings"] = {
                "objectif_kcal": new_kcal,
                "objectif_prot": new_prot,
                "objectif_gluc": new_gluc,
                "objectif_lip":  new_lip
            }
